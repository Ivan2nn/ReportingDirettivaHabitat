        ...
        <div class="section-header">
            <div class="row">
                <div class="col-sm-4 focus-box">
                   ...
                   <a href="{{ route('species-basic-search') }}" class="button-link">Cerca</a>
                ...
                <div class="col-sm-4 focus-box">
                    ...
                    <a href="{{ route('habitat-basic-search') }}" class="button-link">Cerca</a>
...
<div class="container">
    <div class="row">
       <div class="col-md-12">
           <h2 class="c-font-28 c-font-bold c-margin-b-40 c-margin-t-40">REPORTING e MONITORAGGIO della DIRETTIVA HABITAT</h2>
       </div> 
