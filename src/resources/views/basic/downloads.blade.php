...
<div class="c-content-box c-size-md c-bg-white">
    <div class="container">
		...
		<p><strong><a href="{!! asset('public/documents/REP_IV_sch_map/DATI_UFFICIALI_TRASMESSI.zip') !!}" target="_blank">DATI UFFICIALI TRASMESSI</a></strong></p>

		<p><strong>HABITAT</strong></p>  
                    <ul class="c-content-list-1 c-theme c-separator-dot">
                   	<li><a href="{!! asset('public/documents/REP_IV_sch_map/HABITAT_schede.7z') !!}" target="_blank">Schede Reporting (pdf)</a></li>
			<li><a href="{!! asset('public/documents/REP_IV_sch_map/HABITAT_mappe.zip') !!}" target="_blank">Mappe di distribuzione (pdf)</a></li>

                    </ul>		

		<p><strong>SPECIE</strong></p>
                    <ul class="c-content-list-1 c-theme c-separator-dot">
                   	<li><a href="{!! asset('public/documents/REP_IV_sch_map/SPECIE_schede.7z') !!}" target="_blank">Schede Reporting (pdf)</a></li>
			<li><a href="{!! asset('public/documents/REP_IV_sch_map/SPECIE_mappe.zip') !!}" target="_blank">Mappe di distribuzione (pdf)</a></li>
		...
		<p class="c-font-8"><a href="http://cdr.eionet.europa.eu/help/habitats_art17" target="_blank">http://cdr.eionet.europa.eu/help/habitats_art17</a></p>
			...
			<li><a href="{!! asset('public/documents/documenti ufficiali europei/Art17_checklists_2019.xls') !!}" target="_blank">Checklist per specie ed habitat (xls)</a></li>
		...
		<p><strong>SCHEDE DI RILEVAMENTO DI CAMPO</strong></p>
			...
			<li><a href="{!! asset('public/documents/schede di rilevamento di campo/Indicazioni per la compilazione della scheda habitat.pdf') !!}" target="_blank">Indicazione per la compilazione scheda habitat (pdf)</a></li> 
			<li><a href="{!! asset('public/documents/schede di rilevamento di campo/Scheda HABITAT.xlsx') !!}" target="_blank">Scheda habitat (xlsx)</a></li>
                    </ul>
...
<h2 class="c-font-uppercase c-font-bold c-font-40 c-margin-b-20 c-margin-t-30">Reporting 2007-2012</h2>
		...
		<ul class="c-content-list-1 c-theme c-separator-dot">
			...
			<li><a href="{!! asset('public/documents/dati_regionali _indice rilevanza.xlsx') !!}" target="_blank">Indice di rilevanza: dati regionali</a></li>
