@extends('partials.layout_III_report')
    ...
    <div class="container">
        <div class="section-header">
            <div class="row">
                ...
                <div class="col-sm-6 focus-box">@extends('partials.layout')
                            ...
                            <div class="section-header">
                                <div class="row">
                                    <div class="col-sm-4 focus-box">
                                        ...
                                        <p>Ricerca dati 3° report (2009-2012) per le specie animali e vegetali</p>
                                    ...
                                    <div class="col-sm-4 focus-box">
                                        ...
                                        <p>Ricerca dati 3° report (2009-2012) per gli habitat</p>
                                       {{--  <a href="" class="button-link">link text</a> --}}
