			...
			<div class="row">
				...
				<div class="row">
					<div class="row c-margin-b-30">
						<h2 class="c-font-bold" style="margin-left:30px;">Legenda</h2>
					</div>
					<div class="row">
						<div class="col-sm-3">
						...
						<div class="col-sm-3">
							<h4 class="c-margin-b-20">Presenza</h4>
							<ul class="list-unstyled">
						...
						<div class="col-sm-3">
							<h4 class="c-margin-b-20">Stato di Conservazione</h4>
							<ul class="list-unstyled">
						...
						<div class="col-sm-3">
							<h4 class="c-margin-b-20">Trend</h4>
							<ul class="list-unstyled">
