...
<div class="c-content-box c-size-md c-bg-white">
    <div class="container">
		...
		<p><strong><a href="ftp://ftp.isprambiente.it" target="_blank" class="c-font-26 color-red">Materiale Cartografico IV Report (accesso limitato a Regioni e Provincie Autonome)</a></strong></p>
		...
		<p class="c-font-8"><a href="http://cdr.eionet.europa.eu/help/habitats_art17" target="_blank">http://cdr.eionet.europa.eu/help/habitats_art17</a></p>
			...
			<li></li>
                ...
                <h2 class="c-font-uppercase c-font-bold c-font-40 c-margin-b-20 c-margin-t-30">Manuali di monitoraggio (2016)</h2>
                    <ul class="c-content-list-1 c-theme c-separator-dot">
		...
		<p><strong>SCHEDE DI RILEVAMENTO DI CAMPO</strong></p>
			...
			<li><a href="{!! asset('public/documents/schede di rilevamento di campo/Scheda HABITAT.docx') !!}" target="_blank">Scheda habitat (doc)</a></li>
                    </ul>
